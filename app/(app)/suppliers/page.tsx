...
import { NewSupplierForm, NewObligationForm, PayObligationButton } from "../../../components/domain/SupplierForms";
          ...
          .map((o) => (
            <div key={o.id} className="row" style={{ alignItems: "center" }}>
              ...
              <span style={{ display: "flex", gap: 8, alignItems: "center" }}>
                ...
                {profile.role === "socio" && <PayObligationButton obligationId={o.id} accounts={accounts} />}
              </span>
            </div>
          ))}
      </section>
